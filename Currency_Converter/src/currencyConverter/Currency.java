...
public class Currency {
	...
	public void defaultValues() {
		...
		switch (currency) {
			case "ALL Lek":
				this.exchangeValues.put("ALL", 94.46);
				this.exchangeValues.put("USD", 0.011);
				this.exchangeValues.put("EUR", 0.0097);
				this.exchangeValues.put("GBP", 0.0085);
				this.exchangeValues.put("CHF", 0.0094);
				this.exchangeValues.put("CNY", 0.076);
			...
			case "US Dollar":
				...
				break;
			case "Euro":
				this.exchangeValues.put("ALL", 102.81);
				...
				break;
			case "British Pound":
				this.exchangeValues.put("ALL", 117.98);
				...
				break;
			case "Swiss Franc":
				this.exchangeValues.put("ALL", 106.81);
			...
			case "Chinese Yuan Renminbi":
				this.exchangeValues.put("ALL", 13.25);
				...
				break;
			case "Japanese Yen":
				this.exchangeValues.put("ALL", 0.63);
	...
	public static ArrayList<Currency> init() {
		...
		currencies.add( new Currency("ALL Lek", "ALL") );
